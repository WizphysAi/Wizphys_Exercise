...
private float CheckStandStillRight()
    ...
    private float CheckSRSERight()
    {
        ...
        CheckSRSECount = (SRSEAngle > 25.0f) ? (CheckSRSECount + 1) : CheckSRSECount = 0;
    ...
    private float CheckSRSELeft()
    {
        ...
        CheckSRSECount = (SRSEAngle > 27.0f) ? (CheckSRSECount + 1) : CheckSRSECount = 0;
    ...
    private float CheckBackBendRight()
    {
        ...
        BackBendCount = (torsoslopeRight < -10.0f) ? (BackBendCount + 1) : (BackBendCount = 0);
    ...
    private float CheckBackBendLeft()
    {
        ...
        BackBendCount = (torsoslopeLeft < -4.0f) ? (BackBendCount + 1) : (BackBendCount = 0);
